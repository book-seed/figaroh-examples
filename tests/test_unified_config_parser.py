...
class TestUnifiedConfigParser:
    ...
    def test_basic_config_loading(self, temp_config_dir, mock_robot):
        ...
        config_content = {
            ...
            "robot": {
                "name": "test_robot",
                "properties": {"joints": {"active_joints": ["joint1", "joint2"]}},
            },
            "tasks": {
                "calibration": {
                    "enabled": True,
    ...
    def test_variable_expansion(self, temp_config_dir, mock_robot):
        ...
        config_content = {
            ...
            "tasks": {
                "calibration": {
                    "data": {"source_file": "data/${TEST_ROBOT_NAME}_calibration.csv"}
                }
            },
            "variables": {"CONFIG_VALUE": "test_value"},
        }
...
class TestConfigurationCompatibility:
    ...
    def test_legacy_calibration_format(self, mock_robot):
        ...
        legacy_config = {
            ...
            "tool_frame": "tool",
            "markers": [
                {"ref_joint": "joint3", "measure": [True, True, True, True, True, True]}
            ],
            "nb_sample": 50,
            "non_geom": False,
            "free_flyer": False,
    ...
    def test_legacy_identification_format(self, mock_robot):
        ...
        legacy_config = {
            ...
            "processing_params": [{"ts": 0.001, "cut_off_frequency_butterworth": 50.0}],
            "tls_params": [{"mass_load": 0.0, "which_body_loaded": 0.0}],
        }
    ...
    def test_create_task_config(self, mock_robot):
        ...
        unified_config = {
            ...
            "tasks": {
                ...
                "identification": {"enabled": False, "type": "dynamic_identification"},
            },
            "custom": {"manufacturer": "Test Corp"},
        }
